...
- Drives Heltec Vision Master E213/E290 and Wireless Paper boards over USB serial or Bluetooth Low Energy. Board family and framebuffer geometry stay distinct, so pinouts cannot cross-flash. The app detects the USB board and offers one Flash action; supported Wireless Paper revisions select their display controller inside the firmware at boot.
