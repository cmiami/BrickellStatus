...
pub const BRIDGE_FORECAST_MODEL_VERSION: &str = "brickell-v1";
        ...
        for item in evidence {
            ...
            match scored.disposition {
                ...
                | ContributionDisposition::Authoritative => {
                    ...
                    // Controller truth is the outcome we eventually compare a
                    // forecast against, never a predictive feature. Excluding
                    // it here also prevents a controller plus one live source
                    // from manufacturing the corroboration bonus.
